...
void FoldersAnalysis::displayResults() const {
    ...
    << _txtFiles << std::endl << " - Fichiers avec des problèmes de confidentialité : " << _confidentialityTxt
    << std::endl << std::endl << "HTML :" << std::endl << " - Nombre de fichiers : "
    << _htmlFiles << std::endl << " - Fichiers avec des problèmes de confidentialité : " << _confidentialityHtml
    << std::endl << std::endl << "Audio :" << std::endl << " - Nombre de fichiers : "
    << _audioFiles << std::endl << " - Fichiers avec des problèmes de confidentialité : N/A"
    << std::endl << std::endl << "Images :" << std::endl << " - Nombre de fichiers : "
    << _imagesFiles << std::endl << " - Fichiers avec des problèmes de confidentialité : N/A"
    << std::endl << std::endl << "Videos :" << std::endl << " - Nombre de fichiers : "
    << _videosFiles << std::endl << " - Fichiers avec des problèmes de confidentialité : N/A"
    << std::endl << std::endl << "Problèmes rencontres :" << std::endl << " - 'Licence free access' manquant dans "
